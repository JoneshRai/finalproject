                    ...
                    <div className="collapse navbar-collapse" id="navbarCollapse">
                        {/* Search Bar */}
                            <div className="nav mt-3 mt-lg-0 px-4 flex-nowrap align-items-center">
                                <div className="nav-item" style={{ width: "400px" }}> {/* Adjust width as needed */}
                                    <form className="rounded position-relative">
                                        <input className="form-control pe-5 bg-light" type="search" placeholder="Search " aria-label="Search" />
                        ...
                        <ul className="navbar-nav navbar-nav-scroll ms-auto">
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" href="http://127.0.0.1:8000/">
                                 Messages
                                </a>
                            </li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                                    ...
                                    <li>
                                        <Link className="dropdown-item" to="/bookevent/">
                                            <i className="fa-solid fa-pen-to-square"></i> Book Event
                                        </Link>
                                    </li>
                                </ul>
                            </li>
