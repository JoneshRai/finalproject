                            ...
                            <div className="card-body p-6">
                                ...
                                <form className="needs-validation" onSubmit={handleRegister}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="password" id="password" className="form-control" onChange={handleBioDataChange} value={bioData.password} name="password" placeholder="**************" required="" />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="password" className="form-label">
                                            Confirm Password
                                        </label>
                                        <input type="password" id="password" className="form-control" onChange={handleBioDataChange} value={bioData.password2} name="password2" placeholder="**************" required="" />
                                    </div>
