...
function EditPost() {
    ...
    const fetchPost = async () => {
        const response = await apiInstance.get(`/DashboardUpdatePost/${userId}/${param.id}/`);
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            const response = await apiInstance.patch(`DashboardUpdatePost/${userId}/${param.id}/`, formdata, {
                headers: {
